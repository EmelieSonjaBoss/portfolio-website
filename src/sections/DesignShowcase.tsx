...
const designProjects: DesignProject[] = [
  {
    ...
    figmaLink:
      "https://www.figma.com/proto/7Zp71DUytHbfHRE0oIpuMR/Fika-Finder?node-id=93-3711&p=f&t=ILD26o72kk9rlShS-1&scaling=min-zoom&content-scaling=fixed&page-id=17%3A3",
  },
  {
    ...
    figmaLink:
      "https://www.figma.com/proto/1N3tOmFaCJwT3YA3pLFx4x/UX-Grupp-7?node-id=257-392&p=f&t=TkthAaH3XlVtFUnz-1&scaling=scale-down&content-scaling=fixed&page-id=215%3A2&starting-point-node-id=257%3A392&show-proto-sidebar=1",
  },
];
...
const DesignShowcase = () => {
  ...
  useEffect(() => {
    const nodes = projectRefs.map((ref) => ref.current);
