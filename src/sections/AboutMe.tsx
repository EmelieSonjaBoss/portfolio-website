      ...
      <div className={styles.content}>
        <div className={styles.textSection}>
          <p className={styles.mainText}>
            Frontend developer with a passion for clean, responsive web applications. 
        ...
        <div className={styles.highlights}>
          <div className={styles.highlight}>
            ...
            <p>From designing horse blogs as a teen to building modern web applications</p>
          </div>
          <div className={styles.highlight}>
            <span className={styles.icon}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <p>Self-employed farrier with strong business and problem-solving skills</p>
          </div>
          <div className={styles.highlight}>
            <span className={styles.icon}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
