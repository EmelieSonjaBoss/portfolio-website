...
const TechStack = () => {
  ...
  // Get the translated tech stack arrays
  const frontendTech = t(techStackData.frontend, { returnObjects: true }) as string[];
  const backendTech = t(techStackData.backend, { returnObjects: true }) as string[];
  const designTech = t(techStackData.design, { returnObjects: true }) as string[];
  const toolsTech = t(techStackData.tools, { returnObjects: true }) as string[];
  const methodologiesTech = t(techStackData.methodologies, { returnObjects: true }) as string[];
        ...
        <div className={styles.skillGroups}>
          ...
          <div className={styles.skillGroup}>
            <div className={styles.skillGroupHeader}>
              ...
              <h4>{t('techstackh4development')}</h4>
            </div>
            <div className={styles.compactTechList}>
          ...
          <div className={styles.skillGroup}>
            <div className={styles.skillGroupHeader}>
              ...
              <h4>{t('techstackh4methodologies')}</h4>
            </div>
            <div className={styles.compactTechList}>
            {methodologiesTech.map((tech, index) => (
